...
from my_reft_trainer import MyReftTrainer
#from my_sft_trainer import MySFTTrainer
# from my_sft_config  import MySFTConfig
from my_reft_config import MyReftConfig

from trl import setup_chat_format

from utils import read_raw_dataset
from models import get_rl_model_and_tok, get_model_and_tok
...
def main():
    ...
    training_args = MyReftConfig(
        ...
        gradient_checkpointing_kwargs = dict(
            use_reentrant =  False),        
        hub_model_id = "reft-trainer-exps",
    ...
    # parser = H4ArgumentParser((MyReftConfig,))
    ...
    model, ref_model, tokenizer = get_rl_model_and_tok(
