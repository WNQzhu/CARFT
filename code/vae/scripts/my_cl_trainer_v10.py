# wnq::cl_trainer_v10 (from cl_trainer_v9) using augments.
# (1) pos:
# this version takes the positive part of the generated cot
# we extracted the number from the ref and postive generated cot with 1 as the reward
                ...
                for mini_batch_start in range(0, args.local_batch_size, args.local_mini_batch_size):
                    ...
                    for micro_batch_start in range(0, args.local_mini_batch_size, args.per_device_train_batch_size):
                        with accelerator.accumulate(model):
                            ...
                            cl_loss_pos = torch.sum(cl_loss_a) / cl_loss_b
                            ...
                            base_common_mask, base_diff_mask, \
                                ...
                                neg_loss_mask = self.neg_mask(
                                    ...
                                    model_len,
                                    model_idx_seq_list,
                                    cur_model_prefix_len_list, aug_base=True)
                            ...
                            cl_loss = 0.5 * (cl_loss_pos + cl_loss_neg)
                            ## end neg
