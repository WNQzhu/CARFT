...
from utils import read_raw_dataset, get_model_and_tok
...
def _prepare_train_dataset(ds, args, tokenizer):
    ...
    def tokenize_fn(batch, args, tokenizer):
        ...
        for item_values in zip(*(batch[k] for k in all_keys)):
            ...
            new_batch['max_len'].append(input_ids_max_length)
...
def main():
    ...
    max_len = 0
    for data in tok_train_dataset:
        max_len = max(data['max_len'], max_len)
