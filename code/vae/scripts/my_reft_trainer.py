...
class MyReftTrainer(Trainer):
    ...
    def train(self):
        ...
        for update in range(1, args.num_total_batches + 1):
            ...
            model_input_ids, model_attention_mask, mask, rew, score_rew, kl_rew, ret, correctness, val, old_logprob, ref_logprob, adv = self.rollout(
                self.args, new_batch, text_batch,
                generation_config)
            # self.accelerator.print(f"adv: {adv}")
            # preprocess
            raw_adv = adv
