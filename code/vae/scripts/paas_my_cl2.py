...
def main():
    ...
    parser.add_argument('--lr', type=float, default=3.0e-7, help='learning rate')
    ...
    if args.trainer_version == 'cl_trainer_v2':
        from my_cl_trainer_v2 import MyCLTrainer
        print("---wnq:cl_trainer_v2")
    elif args.trainer_version == 'cl_trainer_v3':
        from my_cl_trainer_v3 import MyCLTrainer
        print("---wnq:cl_trainer_v3")
    elif args.trainer_version == 'cl_trainer_v4':
        from my_cl_trainer_v4 import MyCLTrainer
        print("---wnq:cl_trainer_v4")
    elif args.trainer_version == 'cl_trainer_v5':
        from my_cl_trainer_v5 import MyCLTrainer
        print("---wnq:cl_trainer_v5")
    elif args.trainer_version == 'cl_trainer_v6':
        from my_cl_trainer_v6 import MyCLTrainer
        print("---wnq:cl_trainer_v6")
    elif args.trainer_version == 'cl_trainer_v7':
        from my_cl_trainer_v7 import MyCLTrainer
        print("---wnq:cl_trainer_v7")
    elif args.trainer_version == 'cl_trainer_v8':
        from my_cl_trainer_v8 import MyCLTrainer
        print("---wnq:cl_trainer_v8")
    elif args.trainer_version == 'cl_trainer_v9':
        from my_cl_trainer_v9 import MyCLTrainer
        print("---wnq:cl_trainer_v9")
    elif args.trainer_version == 'cl_trainer_v10':
        from my_cl_trainer_v10 import MyCLTrainer
        print("---wnq:cl_trainer_v10")
    elif args.trainer_version == 'cl_trainer_v11':
        from my_cl_trainer_v11 import MyCLTrainer
        print("---wnq:cl_trainer_v11")                
        
    else:
        raise ValueError("No such cl_trainer version!!!")

    training_args = MyCLConfig(
        ...
        run_name = "codellama-cl_v3-svamp",
