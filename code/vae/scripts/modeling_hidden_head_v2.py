...
class ValueHead(nn.Module):
    ...
    def __init__(self, config, **kwargs):
        ...
        self.proj = nn.Linear(hidden_size, self.proj_dim)

        self.act = nn.ReLU()
        
        self.summary = nn.Linear(self.proj_dim, 1)
    ...
    def forward(self, hidden_states):
        ...
        proj_output = self.proj(output)
        
        val = self.summary(self.act(proj_output))
        
        return val, proj_output


class AutoModelForCausalLMWithValueHeadV2(PreTrainedModelWrapper):
    r"""
    ...
    def forward(
        ...
        **kwargs,
        ...
        value, emb = self.v_head(last_hidden_state)
        ...
        if return_past_key_values:
            return (lm_logits, loss, value, emb, base_model_output.past_key_values)
        else:
            return (lm_logits, loss, value, emb)
